...
### CCA ###
import transformers
from llava.cca_utils.cca import cca_forward, llamaforcausallm_if_vis_forward
transformers.models.llama.LlamaModel.forward = cca_forward
transformers.models.llama.LlamaForCausalLM.forward = llamaforcausallm_if_vis_forward
...
def eval_model(args):
    ...
    for idx, line in enumerate(tqdm(questions)):
        ...
        ans_file.write(json.dumps({"question_id": idx,
                                   "prompt": cur_prompt,
                                   "text": outputs,
                                   "text_image_if": text_image_if.tolist(),
                                   "answer_id": ans_id,
                                   "model_id": model_name,
                                   "metadata": {}}) + "\n")
        ans_file.flush()
